...
_ALIAS_GROUPS: Dict[str, Tuple[str, ...]] = {
    ...
    "io-net": ("ionet", "io-intelligence", "io_net"),
...
_LABEL_OVERRIDES: Dict[str, str] = {
    ...
    "io-net": "IO Intelligence", "nebius-token-factory": "Nebius Token Factory", "tencent-tokenplan": "Tencent TokenPlan", "lmstudio": "LM Studio",
